...
suite =
    describe "Day 6 Tests"
        [ describe "Part 1"
            [ test "Example 1" <|
                \_ -> "abc" |> parseGroup |> Set.size |> equal 3
            , test "Example 2" <|
                \_ -> "a\nb\nc" |> parseGroup |> Set.size |> equal 3
            , test "Example 3" <|
                \_ -> "ab\nac" |> parseGroup |> Set.size |> equal 3
            , test "Example 4" <|
                \_ -> "a\na\na\na" |> parseGroup |> Set.size |> equal 1
            , test "Example 5" <|
                \_ -> "b" |> parseGroup |> Set.size |> equal 1
            , test "Problem" <|
                \_ ->
                    problem
                        |> String.split "\n\n"
        ...
        , describe "Part 2"
            [ test "Example 1" <|
                \_ -> "abc" |> parseGroupNew |> Set.size |> equal 3
            , test "Example 2" <|
                \_ -> "a\nb\nc" |> parseGroupNew |> Set.size |> equal 0
            , test "Example 3" <|
                \_ -> "ab\nac" |> parseGroupNew |> Set.size |> equal 1
            , test "Example 4" <|
                \_ -> "a\na\na\na" |> parseGroupNew |> Set.size |> equal 1
            , test "Example 5" <|
                \_ -> "b" |> parseGroupNew |> Set.size |> equal 1
            , test "Problem" <|
                \_ ->
                    problem
                        |> String.split "\n\n"
