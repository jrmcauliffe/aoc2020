...
suite =
    describe "Day 7 Tests"
        [ describe "Part 1"
            [ test "Example 1" <|
                \_ -> example |> String.split "\n" |> List.filterMap parseBagRule |> containsCount "shiny gold" |> equal 4
            , test "Part 1 Problem" <|
                \_ -> problem |> String.split "\n" |> List.filterMap parseBagRule |> containsCount "shiny gold" |> equal 185
            ]
        , describe "Part 2"
            [ test "Example 1" <|
                \_ -> example |> String.split "\n" |> List.filterMap parseBagRule |> insideCount "shiny gold" |> equal 32
            , test "Example 2" <|
